...
with conn:
    ...
    cur.execute('DROP VIEW IF EXISTS WeiWeiRating')
    cur.execute(query_1)
    cur.execute('SELECT * FROM WeiWeiRating;')
    ...
    cur.execute('DROP VIEW IF EXISTS maxRating')
    cur.execute(query_2)
    cur.execute('SELECT * FROM maxRating;')
    ...
    cur.execute('DROP VIEW IF EXISTS ratingDesc')
    cur.execute(query_3)
    cur.execute('SELECT * FROM ratingDesc;')
